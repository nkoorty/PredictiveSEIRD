...
# Define the grid for Stockholm
shape = (100, 100)  # Grid shape
extent = (14.0, 13.0)  # Physical dimensions (approximate extent of Stockholm in km)
...
# Parameters (adjust as necessary for Stockholm)
alpha = 0  # Birth rate
...
population_density = gaussian_filter(population_density, sigma=5)
S.data[:] = 0.89 * population_density
E.data[:] = 0.10 * population_density
I.data[:] = 0.01 * population_density  # Spread initial infected population uniformly
R.data[:] = 0.0
D.data[:] = 0.0
